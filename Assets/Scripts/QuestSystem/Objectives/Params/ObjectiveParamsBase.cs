...
namespace FlavorfulStory.QuestSystem.Objectives.Params
{
    ...
    public abstract class ObjectiveParamsBase
    {
        ...
        {
            if (ShouldComplete(status, context, eventData)) CompleteObjective(status, context);
        }
        ...
        protected abstract bool ShouldComplete(QuestStatus status, ObjectiveExecutionContext context, object eventData);
        ...
        {
            var objective = status.Quest.Objectives.SingleOrDefault(o => o.Params == this);
