...
namespace FlavorfulStory.Input
{
	...
	public static class InputWrapper
	{
		...
		{
			return _allowedButtons[button] && UnityEngine.Input.GetButtonDown(button.ToString());
		}
		...
		{
			return _allowedButtons[button] && UnityEngine.Input.GetButtonUp(button.ToString());
		}
		...
		{
			return _allowedButtons[button] && UnityEngine.Input.GetButton(button.ToString());
		}
		...
		public static float GetAxisRaw(InputButton axis)
		{
			return !_allowedButtons[axis]
				? 0.0f
				: // 0.0f => default value
				UnityEngine.Input.GetAxisRaw(axis.ToString());
		}
		...
		public static Vector3 GetMousePosition()
		{
			return !_allowedButtons[InputButton.MousePosition]
				? Vector3.zero : // Vector3.zero => default value) 
