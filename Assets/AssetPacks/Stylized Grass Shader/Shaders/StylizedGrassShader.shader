...
Shader "Universal Render Pipeline/Nature/Stylized Grass"
{
	Properties
	{
		_HeightGradientColor ("Height Gradient Color (RGB) + Intensity (A)", Color) = (1,1,1,0)
		_HeightGradientMin ("Height Gradient Min Y", Float) = 0.0
		_HeightGradientMax ("Height Gradient Max Y", Float) = 1.0
